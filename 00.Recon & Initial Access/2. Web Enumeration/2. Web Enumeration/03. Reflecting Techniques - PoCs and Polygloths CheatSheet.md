...
## [Client Side Template Injection](client-side-template-injection-csti)
...
## [Open Redirect](open-redirect) / [Server Side Request Forgery](ssrf-server-side-request-forgery)
...
## [Server Side Inclusion/Edge Side Inclusion](server-side-inclusion-edge-side-inclusion-injection)
...
## [XSLT Server Side Injection](xslt-server-side-injection-extensible-stylesheet-languaje-transformations)
