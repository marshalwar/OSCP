...
* If the page is **behind a proxy**, maybe it's the proxy the one preventing you you to access the private information. Try abusing [**HTTP Request Smuggling**](../../pentesting-web/http-request-smuggling) **or** [**hop-by-hop headers**](../../pentesting-web/abusing-hop-by-hop-headers)**.**
* Fuzz [**special HTTP headers**](special-http-headers) looking for different response.
...
*   [**Brute force**](../../../brute-force#http-brute)**:** Try basic, digest and NTLM auth.
