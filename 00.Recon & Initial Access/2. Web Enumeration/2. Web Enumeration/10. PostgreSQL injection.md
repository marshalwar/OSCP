...
[**You can read here how to perform these attacked.**](postgresql-injection/network-privesc-port-scanner-and-ntlm-chanllenge-response-disclosure)\*\*\*\*

### **Exfiltration example using dblink and large objects**

You can [**read this example**](postgresql-injection/dblink-lo_import-data-exfiltration) **\*\*to see a CTF example of** how to load data inside large objects and then exfiltrate the content of large objects inside the username\*\* of the function `dblink_connect`.
...
**You can abuse this language in order to ask PostgreSQL to brute-force the users credentials.** [**Read this to learn how.**](postgresql-injection/pl-pgsql-password-bruteforce)\*\*\*\*
...
[**Read this page to learn how to do it.**](postgresql-injection/big-binary-files-upload-postgresql)\*\*\*\*
...
[**Lear how to abuse this functionality reading this post.**](postgresql-injection/rce-with-postgresql-extensions)\*\*\*\*
...
![](https://1116388331-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-Mks5MA8MikNk7jIq3z3%2Fsync%2F5c13d91bec80cbd97f28e9809c69cc9b0017fec2.png?generation=1633028920408197\&alt=media)
